...
<body style="background-color:#231c16">
                ...
                <div class="col col-10 mt-5 mt-xxl-5 mb-xxl-5 col-xxl-3">
                    <div class="d-flex w-100 justify-content-center">
                        <div id="login" class="card mt-xxl-5 mb-xxl-5">
                            <div class="p-2">
                                <form action="{{ route('Personas.store') }}" class="ps-4 pe-4 mb-3" method="POST">
                                    @csrf
                                    <input id="filtrocartelera" type="button" value="Regresar" class="btn btn-danger ms-2" onclick="history.back()">
                            </div>
                            <div class="d-flex w-100 justify-content-center">
    ...
    <script>
        // Esto establece la fecha de nacimiento al cargar la página
        document.getElementById("fecha_nac").valueAsDate = new Date();
    </script>
</body>
</html>
