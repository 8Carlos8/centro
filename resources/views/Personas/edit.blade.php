                ...
                <form action="{{ route('Personas.update', $persona->id) }}" method="POST">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" id="a_paterno" name="a_paterno" placeholder="Apellido" value="{{ $persona->a_paterno }}">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" class="form-control" id="a_materno" name="a_materno" placeholder="Apellido" value="{{ $persona->a_materno }}">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                $fecha = date('Y-m-d', strtotime($persona->fecha_nac));
                                ?>
                                <input type="date" class="form-control" id="fecha_nac" name="fecha_nac" placeholder="" value="{{ $fecha }}">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <div class="row column-gap-">
                                    ...
                                    <input type="text" class="form-control w-50" id="telefono" name="telefono" placeholder="Telefono (10 Digitos)" value="{{ $persona->telefono }}">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="d-flex mt-3 justify-content-center">
                                <button type="submit" class="btn btn-success"><i class="bi bi-save-fill"></i>&nbsp;Editar</button>
                                <a href="{{ route('Personas.index') }}" class="btn btn-danger ms-2 text-end"><i class="bi bi-arrow-return-left"></i>&nbsp;Regresar</a>
                            </td>
                        </tr>
                    </table>
                </form>
