                ...
                <table class="table mt-4">
                    <tr>
                        ...
                        <td class="control-label ms-2">
                            <select class="form-select" id="id_evento" name="id_evento">
                                ...
                                <option value="{{ $evento->id }}" {{ $evento->id == $cartelera->id_evento ? 'selected' : ''}}>{{ $evento->nombre }}</option>
                                @endforeach
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="control-label ms-2">
                            <select class="form-select" id="id_sala" name="id_sala">
                                ...
                                <option value="{{ $sala->id }}" {{ $sala->id == $cartelera->id_sala ? 'selected' : ''}}>{{ $sala->nombre }}</option>
                                @endforeach
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="control-label ms-2">
                            ...
                            $fecha_entrada = date('Y-m-d', strtotime($cartelera->inicio));
                            ?>
                            <input type="date" id="inicio" name="inicio" class="form-input" value="{{ $fecha_entrada }}">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="control-label ms-2">
                            <?php
                            // Convertir la fecha al formato adecuado (aaaa-mm-dd)
                            $fecha_entrada = date('Y-m-d', strtotime($cartelera->fin));
                            ?>
                            <input type="date" id="fin" name="fin" class="form-input" value="{{ $fecha_entrada }}">
                        </td>
                    </tr>
