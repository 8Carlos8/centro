...
<div class="container w-50 py-2 justify-content-center">
    <div class="card mt-4">
        ...
        <div class="mb-4 ">
            <button href="{{ route('Estacionamientos.index') }}" class="btn btn-danger ms-2"><i class="bi bi-arrow-return-left"></i>&nbsp;Regresar al Listado</button>
            <a href="{{ route('Personas.index') }}" class="btn btn-danger ms-2 text-end"><i class="bi bi-arrow-return-left"></i>&nbsp;Regresar al panel</a>
        </div>
            
        <div class="card-body">
            <form action="{{ route('Estacionamientos.reporte') }}" method="GET" class="text-center">
                <div class="mb-3">
    ...
    <div class="container w-50 py-2 justify-content-center">
        <div class="card mt-4">
            <div class="bg-gray-100 p-4 rounded-lg mb-4">
                    ...
                    <p>Cajones activos: {{ $cajonesOcupados  }}</p>
                    <p>Cajones inactivos: {{ $cajonesReservados  }}</p>
